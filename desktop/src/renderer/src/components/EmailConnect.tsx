 ...
 * why). There's no BotServiceControl equivalent here yet: no connector
 * process reads this file today, so saving just gives the credential
 * somewhere real to live until the IMAP fetch loop exists to use it. */
      ...
      {justSaved ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <div style={{ fontSize: 12.5, color: 'var(--text-secondary)' }}>
            Saved. Order confirmation, tracking, and cancellation emails will be read once the email connector is
            live -- this just gives Cache somewhere to keep the credential until then.
          </div>
